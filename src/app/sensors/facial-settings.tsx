...
const styles = StyleSheet.create({
    ...
    sectionLabel: { color: "#71717A", fontSize: 13, fontWeight: "bold", textTransform: "uppercase", letterSpacing: 1, marginBottom: 16, marginTop: 32 },
    ...
    fieldLabel: { color: "#71717A", fontSize: 12, fontWeight: "bold", textTransform: "uppercase", letterSpacing: 1, marginTop: 16, marginBottom: 8 },
