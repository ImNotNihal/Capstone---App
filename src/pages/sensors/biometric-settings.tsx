                ...
                {loading ? (
                    ...
                    prints.map((print) => (
                        <View key={print.id} style={styles.printCard}>
                            ...
                            {deletingId === print.id ? (
                                <ActivityIndicator style={styles.deleteBtn} size="small" color="#EF4444" />
                            ) : (
                                <TouchableOpacity
...
const styles = StyleSheet.create({
    ...
    // Register Card
    registerCard: { width: '100%', backgroundColor: "#10B98110", borderRadius: 24, padding: 20, flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: '#10B98130', zIndex: 10 },
    ...
    // Print Cards
    printCard: { width: '100%', backgroundColor: "#09090B", borderRadius: 20, padding: 16, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderWidth: 1, borderColor: '#18181B', marginBottom: 12, zIndex: 5 },
    ...
    stepNum: { color: "#71717A", fontSize: 12, fontWeight: "bold" },
