...
const styles = StyleSheet.create({
    ...
    feedWrapper: { width: '100%', aspectRatio: 16 / 10, marginBottom: 24 },
    cameraFeed: { flex: 1, overflow: 'hidden' },
    zoneOverlay: { flex: 1, flexDirection: 'row', flexWrap: 'wrap', padding: 10, gap: 10 },
    zoneBox: { width: '48%', height: '46%', borderRadius: 12, borderWidth: 2, borderStyle: 'dashed', justifyContent: 'center', alignItems: 'center' },
    zoneBoxActive: { borderColor: '#8B5CF6', backgroundColor: 'rgba(139, 92, 246, 0.15)' },
    zoneBoxInactive: { borderColor: 'rgba(255, 255, 255, 0.2)', backgroundColor: 'rgba(0, 0, 0, 0.4)' },
    zoneLabel: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 6 },
    zoneLabelText: { color: '#FAFAFA', fontSize: 10, fontWeight: '700' },
    liveBadge: { position: 'absolute', top: 16, right: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.6)', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 12, gap: 6 },
    liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#EF4444' },
    liveText: { color: '#FAFAFA', fontSize: 10, fontWeight: '700' },
    controlsCard: { backgroundColor: "#09090B", borderRadius: 24, padding: 20, borderWidth: 1, borderColor: "#18181B" },
    settingRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    settingTitle: { color: "#FAFAFA", fontSize: 15, fontWeight: "700" },
    settingDesc: { color: "#71717A", fontSize: 13, marginTop: 2 },
    divider: { height: 1, backgroundColor: '#18181B', marginVertical: 20 },
    sliderSection: { width: '100%' },
    segmentRow: { flexDirection: 'row', marginTop: 12, borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#27272A' },
    segment: { flex: 1, paddingVertical: 10, alignItems: 'center', backgroundColor: '#0A0A0A' },
    segmentActive: { backgroundColor: '#8B5CF6' },
    segmentText: { color: '#71717A', fontSize: 13, fontWeight: '600' },
    segmentTextActive: { color: '#FAFAFA' },
    infoBox: { flexDirection: 'row', backgroundColor: '#8B5CF610', padding: 16, borderRadius: 16, marginTop: 20, gap: 12, alignItems: 'center', borderWidth: 1, borderColor: '#8B5CF620' },
    infoText: { color: '#A78BFA', fontSize: 13, flex: 1, lineHeight: 18 },
    saveButton: { backgroundColor: '#FAFAFA', height: 56, borderRadius: 16, justifyContent: 'center', alignItems: 'center', marginTop: 32 },
    saveButtonText: { color: '#050505', fontSize: 16, fontWeight: '700' },
});
